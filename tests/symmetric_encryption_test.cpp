                                    ...
                                    const PASTA_3_MODIFIED_1::PASTA &encryptor)
{
    ...
    cout << "TEST: symmetric_data_encryption_test test passed!" << endl;
} 
...
void symmetric_key_he_encryption_test(vector<uint64_t> ssk,
                                      bool USE_BATCH, 
...
{
    PASTA_3_MODIFIED_1::PASTA_SEAL M1(context, pk, sk);
    auto enc_ssk_pasta = M1.encrypt_key_2(ssk, USE_BATCH);
    // vector<Ciphertext> enc_ssk_pasta = M1.get_enc_sk();
    ...
    cout << "TEST: symmetric_key_he_encryption_test test passed!" << endl;
}
