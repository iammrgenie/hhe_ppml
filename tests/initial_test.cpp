...
int main () {
    ...
    if (mod_degree == 65536) {
        ...
        parms.set_coeff_modulus({
                ...
                0xffffffffcdc0001, 0xffffffffcc40001
            });  // 1740 bits
        } else {
    ...
    ANAL.square(User1.c_2, User1.c_1);


    //Decrypt the Decomposed Ciphertext by the Analyst
    cout << "\nDecryption of Final Message using SK ...\n" << flush;
    User1.x_p = ANAL.decrypt_result(User1.c_2, USE_BATCH);
    print_vec(User1.x_p, 1, "Decrypted Message ");
